...
class TestValidLd(unittest.TestCase):
    ...
    def test_Given_WrongOP1_Produce_CorrectErrorString(self):
        ...
        self.assertEqual(validlib.valid_ld(symbol_table, []), validlib.ERROR_OPERAND_TYPE_STR(test_vars.TOK_IMM5_1))
        self.assertEqual(validlib.valid_ld(symbol_table2, []), validlib.ERROR_OPERAND_TYPE_STR(test_vars.HEX_VAL_0X20))
        self.assertEqual(validlib.valid_ld(symbol_table3, []), validlib.ERROR_OPERAND_TYPE_STR(test_vars.TOK_LABEL_LOOP))

    # Testing
    # LD R1 #1 = error_str
    # LD R1 0X20 = error_str
    # LD R1 R1 = error_str
    def test_Given_WrongOP2_Produce_CorrectErrorString(self):
        ...
        self.assertEqual(validlib.valid_ld(symbol_table, []), validlib.ERROR_OPERAND_INVALID_LABEL(test_vars.TOK_IMM5_1))
        self.assertEqual(validlib.valid_ld(symbol_table2, []), validlib.ERROR_OPERAND_INVALID_LABEL(test_vars.HEX_VAL_0X20))
        self.assertEqual(validlib.valid_ld(symbol_table3, []), validlib.ERROR_OPERAND_INVALID_LABEL(test_vars.TOK_R1))
    ...
    def test_Given_TooManyOperands_Produce_CorrectErrorString(self):
        ...
        self.assertEqual(validlib.valid_ld(symbol_table, []), validlib.ERROR_OPERAND_LENGTH_STR(2, len(symbol_table[utils.KEY_OPERANDS]))) 
