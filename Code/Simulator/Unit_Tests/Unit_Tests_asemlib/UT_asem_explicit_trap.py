...
class TestParseExplicitTrap(unittest.TestCase):
    ...
    def test_Given_GETC_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(asemlib.asem_explicit_trap(address, tokens, []), '1111000000100000')
    ...
    def test_Given_OUT_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(asemlib.asem_explicit_trap(address, tokens, []), '1111000000100001')
    ...
    def test_Given_PUTS_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(asemlib.asem_explicit_trap(address, tokens, []), '1111000000100010')
    ...
    def test_Given_IN_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(asemlib.asem_explicit_trap(address, tokens, []), '1111000000100011')
    ...
    def test_Given_PUTSP_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(asemlib.asem_explicit_trap(address, tokens, []), '1111000000100100')
    ...
    def test_Given_HALT_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(asemlib.asem_explicit_trap(address, tokens, []), '1111000000100101')