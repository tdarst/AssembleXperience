...
class TestValidLdr(unittest.TestCase):
    ...
    # Testing
    # STR #1 R1 #1 = error_str
    # STR 0x20 R1 #1 = error_str
    # STR LOOP R1 #1 = error_str
    ...
    # Testing
    # STR R1 #1 #1 = error_str
    # STR R1 0X20 #1 = error_str
    # STR R1 LOOP #1 = error_str
    ...
    # Testing
    # STR R1 R2 #32 = error_str
    # STR R1 R2 LOOP = error_str
    # STR R1 R2 R1 = error_str
