...
class TestValidRti(unittest.TestCase):
    ...
    def test_Given_AnyNumOfOP_Produce_CorrectErrorString(self):
        ...
        self.assertEqual(validlib.valid_rti(symbol_table, []), validlib.ERROR_OPERAND_LENGTH_STR(0, 1))
        self.assertEqual(validlib.valid_rti(symbol_table2, []), validlib.ERROR_OPERAND_LENGTH_STR(0, 2))
        self.assertEqual(validlib.valid_rti(symbol_table3, []), validlib.ERROR_OPERAND_LENGTH_STR(0, 1))
    ...
    def test_Given_TooManyOperands_Produce_CorrectErrorString(self):
        ...
        self.assertEqual(validlib.valid_rti(symbol_table, []), validlib.ERROR_OPERAND_LENGTH_STR(0, len(symbol_table[utils.KEY_OPERANDS]))) 