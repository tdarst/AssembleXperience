...
class TestParseBr(unittest.TestCase):
    ...
    def test_Given_LDI_R1_LABEL_Offset_Positive_Produce_Correct_Binary_String(self):
        ...
        self.assertEquals(parselib.parse_ldi(address, tokens, label_lookup), '1010001000000000')
    ...
    def test_Given_LDI_R1_LABEL_Offset_Negative_Produce_Correct_Binary_String(self):
        ...
        self.assertEquals(parselib.parse_ldi(address, tokens, label_lookup), '0101001001000010')