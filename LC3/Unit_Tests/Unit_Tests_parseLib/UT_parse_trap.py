...
class TestParseTrap(unittest.TestCase):
    ...
    def test_Given_TRAP_0X20_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(parselib.parse_trap(address, tokens, []), '1111000000100000')
    ...
    def test_Given_TRAP_0X21_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(parselib.parse_trap(address, tokens, []), '1111000000100001')
    ...
    def test_Given_TRAP_0X22_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(parselib.parse_trap(address, tokens, []), '1111000000100010')
    ...
    def test_Given_TRAP_0X23_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(parselib.parse_trap(address, tokens, []), '1111000000100011')
    ...
    def test_Given_TRAP_0X24_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(parselib.parse_trap(address, tokens, []), '1111000000100100')
    ...
    def test_Given_TRAP_0X25_Produce_Correct_Binary_String(self):
        ...
        self.assertEqual(parselib.parse_trap(address, tokens, []), '1111000000100101')